...
object OrganizationPolicies {
    ...
    fun canGet(authedUser: AuthedUserDTO, organizationId: String): Boolean {
        return authedUser.hasRole(Role.IM_ORGANIZATION_READ) || authedUser.memberOf == organizationId
    }
    ...
    fun canList(authedUser: AuthedUserDTO): Boolean {
        return authedUser.hasRole(Role.IM_ORGANIZATION_READ)
    }
    ...
    fun canCreate(authedUser: AuthedUserDTO): Boolean {
        return authedUser.hasRole(Role.IM_ORGANIZATION_WRITE)
    }
    ...
    fun canUpdate(authedUser: AuthedUserDTO, organizationId: OrganizationId): Boolean {
        return authedUser.hasRole(Role.IM_ORGANIZATION_WRITE)
                || authedUser.hasRole(Role.IM_MY_ORGANIZATION_WRITE) && authedUser.memberOf == organizationId
    }
