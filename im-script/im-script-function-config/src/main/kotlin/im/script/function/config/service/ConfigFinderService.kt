...
class ConfigFinderService(
    ...
    suspend fun getRole(authRealm: AuthRealm, name: RoleName): RoleModel? {
    ...
    suspend fun getUser(authRealm: AuthRealm, email: String): UserModel? {
