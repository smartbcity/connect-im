package city.smartb.im.bdd.core.privilege.role.command//package city.smartb.im.bdd.steps.s2.role.command
//
...
//
//class RoleUpdateSteps: En, ImCucumberStepsDefinition() {
//
//    @Autowired
